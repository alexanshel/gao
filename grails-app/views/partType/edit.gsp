      ...
      <table>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: partTypeInstance, field: 'childs', 'errors')}">
            ...
            <g:link controller="partType" action="create"
                    params="['partType.id': partTypeInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'partType.label', default: 'PartType')])}</g:link>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: partTypeInstance, field: 'kind', 'errors')}">
            <g:select name="kind.id" from="${org.ash.gao.part.PartKind.list()}" optionKey="id"
                      value="${partTypeInstance?.kind?.id}" noSelection="['null': '']"/>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: partTypeInstance, field: 'parts', 'errors')}">
            ...
            <g:link controller="part" action="create"
                    params="['partType.id': partTypeInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'part.label', default: 'Part')])}</g:link>
