            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.parent.label" default="Parent" /></td>
                            
                            <td valign="top" class="value"><g:link controller="location" action="show" id="${locationInstance?.parent?.id}">${locationInstance?.parent?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.url.label" default="Url" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: locationInstance, field: "url")}</td>
