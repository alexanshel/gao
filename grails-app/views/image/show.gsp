      ...
      <div class="dialog">
        <table>
          <tbody>
            ...
            <tr class="prop">
              <td valign="top" class="name"><g:message code="image.data.label" default="Data" /></td>
              
              <td valign="top" class="value">
<%--                <img src="g.createLink(controller: 'image')"/> ${fieldValue(bean: imageInstance, field: "data")}--%>
              </td>
            </tr>
